# CogPer — Tabla de Períodos Contables

**Biblioteca:** COGLIB  
**Tipo:** Tabla física  
**Módulo:** COG — Contabilidad General  
**Descripción:** Catálogo de períodos contables. Define los períodos (meses/años) del calendario contable de la empresa, con sus fechas de apertura, cierre y estado.
...
|------|--------|-------------|
| PK | — | Clave primaria — compañía + período |
...
- Tabla central del calendario contable; referenciada por todas las tablas de movimientos.
