# CogEdgd — Detalles Diario de Transacciones Eliminados

**Biblioteca:** COGLIB  
**Tipo:** Tabla física  
**Módulo:** COG — Contabilidad General  
**Descripción:** Detalles de asientos contables eliminados. Almacena el detalle de las líneas de asientos que han sido anulados o eliminados, para registro de auditoría.
...
|------|--------|-------------|
| PK | — | Clave compuesta cabecera eliminada + línea |
...
|-------------|-------------------|----------|-------------|
| — | CogEdgh | — | Cabecera del asiento eliminado |
...
- Auditoría de asientos eliminados; su cabecera es `CogEdgh`.
