# CogCbtd — Detalles Conciliación Bancaria Temporal

**Biblioteca:** COGLIB  
**Tipo:** Tabla física  
**Módulo:** COG — Contabilidad General  
**Descripción:** Detalles temporales de la conciliación bancaria. Almacena las partidas en proceso de conciliación antes de ser confirmadas y pasadas a la tabla definitiva.
...
|------|--------|-------------|
| PK | — | Clave compuesta banco + período + secuencia |
...
|-------------|-------------------|----------|-------------|
| — | CogCbad | — | Detalles definitivos de conciliación |
| — | CogBan | — | Banco |
...
- Tabla temporal de trabajo para conciliación bancaria; al confirmar pasa a `CogCbad`.
