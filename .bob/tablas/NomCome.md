...
**Descripción:** Detalle de comisiones externas. Contiene el desglose de cada comisión externa por empleado o agente, con su base de cálculo y monto a pagar.
...
|------|--------|-------------|
| PK | — | Clave compuesta control + empleado |
...
- Detalle de comisiones externas; su control es `NomComc`.
