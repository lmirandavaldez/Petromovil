# CogCefd — Detalle de Estados Financieros

**Biblioteca:** COGLIB  
**Tipo:** Tabla física  
**Módulo:** COG — Contabilidad General  
**Descripción:** Detalle de estados financieros. Almacena las líneas de detalle que componen cada estado financiero (balance general, estado de resultados, etc.).
...
|-------------|-------------------|----------|-------------|
| — | CogEfi | — | Título del estado financiero |
...
- Detalle de líneas del estado financiero; ver `CogEfi` para los títulos.
