# CogRcbhd — Resumen Conciliación Bancaria Histórico

**Biblioteca:** COGLIB  
**Tipo:** Tabla física  
**Módulo:** COG — Contabilidad General  
**Descripción:** Resumen histórico de conciliación bancaria. Almacena los totales y resúmenes de las conciliaciones bancarias de períodos ya cerrados para consulta y auditoría.
...
------------------------------------------------------------------------------------------------------------------------------------
 ...
 APLHOR        53     56      4   0    P   HORA QUE SE APLICO                        HORA_QUE_SE_APLICO
 APLDIA        57     58      2   0    P   DIA QUE SE APLICO                         DIA_QUE_APLICO
 APLMES        59     60      2   0    P   MES QUE APLICO                            MES_QUE_APLICO
 APLANO        61     63      3   0    P   ANO QUE APLICO                            ANO_QUE_APLICO
---
...
- Resumen histórico de conciliaciones; ver `CogRcbtd` para la versión temporal.
