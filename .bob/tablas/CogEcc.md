# CogEcc — Estructura de la Cuenta (Configuración)

**Biblioteca:** COGLIB  
**Tipo:** Tabla física  
**Módulo:** COG — Contabilidad General  
**Descripción:** Estructura de configuración del plan de cuentas. Define los niveles jerárquicos, longitudes de segmento y formato del código contable utilizado por la compañía.
...
- Define la estructura y formato del plan de cuentas; ver también `CogEst`.
