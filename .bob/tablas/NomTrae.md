# NomTrae — Transacciones Externas

**Biblioteca:** NOMLIB  
**Tipo:** Tabla física  
**Módulo:** NOM — Nómina de Pago  
**Descripción:** Transacciones externas de nómina. Almacena las transacciones importadas desde sistemas externos (tiempo y asistencia, ventas, producción) para su incorporación al cálculo de nómina.
...
| — | NomTra | — | Transacciones procesadas |

---

## Observaciones

- Transacciones importadas de sistemas externos; ver `NomTratxt` para el archivo plano.
