# CogClat — Clasificación Gastos Temporal

**Biblioteca:** COGLIB  
**Tipo:** Tabla física  
**Módulo:** COG — Contabilidad General  
**Descripción:** Clasificación temporal de gastos. Tabla de trabajo para la clasificación de gastos en proceso antes de ser confirmada al histórico.
...
|-------------|-------------------|----------|-------------|
| — | CogClah | — | Clasificación histórica de gastos |
...
- Tabla temporal de trabajo; al confirmar pasa a `CogClah`.
