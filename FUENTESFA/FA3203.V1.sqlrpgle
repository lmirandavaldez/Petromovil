     ...
     c                   Kfld                    ArtCve
      *
     c     *Like         Define    FecYmd        FecDes
     c     *Like         Define    FecYmd        FecHas
      *
    ...
    *  Para Copiar el Presupuesto de clientes Migrado
      ...
      * ----------------------------------------------------------*
     c     Proceso       BegSr
     c     *Like         Define    DtoCua        CuoPro
     c     *Like         Define    DtoCua        CuoMax
     c     *Like         Define    DtoCua        CuoAvg
      *
     c/Exec Sql
      ...
      *
     c                   If        CuoPro = *Zeros
     c                   Eval      CuoPro = CuoAvg
     c                   EndIf
      *
     c                   Eval      CpcCvc = CuoPro
     c                   Eval      CpcCvm = CuoMax
     c                   Eval      CpcCvt = DtoCua
     c                   Write     FacCpcf
     c                   EndIf
      *
     c                   EndDo
