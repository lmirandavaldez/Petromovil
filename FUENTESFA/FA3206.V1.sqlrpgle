      ...
      /Free
        ...
        //Crear Tabla para Exportar a Excel
           Exec Sql
            ...
            Case
                // COLAS (VEHTIP = 1) */
            When V.VehTip = 1 And C.Capacidad_Nominal Between 1 And 11999
            ...
            When V.VehTip = 1 And C.Capacidad_Nominal >= 12000
                ...
                // RÍGIDOS (VehTip = 2) */
            When V.VehTip = 2 And C.Capacidad_Nominal Between 1 And 2999
            ...
            C.Capacidad_Nominal As CapNom,

            Decimal((Sum(T1.PlaTce) * 100.0 / C.Capacidad_Nominal),
              11,4) AS KPIEFIC,
            Decimal((Count(*) * 1.0 / Count(Distinct T1.PlaFpl)),
              11,4) AS KPIINT,
            Decimal((Sum(T1.PlaTce) * 1.0 / Count(Distinct T1.PlaFpl)),
              11,4) AS KPIPROD,
            Decimal((Sum(T1.PlaCbu) * 1.0 / C.Capacidad_Nominal),
              11,4) As KPIAPRO,
